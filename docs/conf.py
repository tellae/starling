...
htmlhelp_basename = "Starling-doc"
...
latex_documents = [
    (master_doc, "starling.tex", "Starling documentation", "Tellae", "manual"),
]
...
man_pages = [(master_doc, "starling", "Starling documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        author,
        "Starling",
        "Agent-based simulation framework for mobility.",
        "Miscellaneous",
    ),
]
