...
from starling_sim.utils.paths import MODELS_FOLDER, INPUT_FOLDER_NAME, OUTPUT_FOLDER_NAME, SCHEMA_FOLDER
...
class SimulationParameters:
    ...
    def __init__(self, parameters, param_schema_path=None):
        ...
        if param_schema_path is None:
            param_schema_path = SCHEMA_FOLDER + self.BASE_PARAM_SCHEMA
...
def add_paths_to_parameters(parameters):
    ...
    # architecture is DATA_FOLDER/MODELS_FOLDER/MODEL/SCENARIO/INPUT~OUTPUT

    scenario_folder = MODELS_FOLDER + model_code + "/" + scenario + "/"

    # input folder
    input_folder = scenario_folder + INPUT_FOLDER_NAME + "/"
    parameters["input_folder"] = input_folder

    # output folder (will be generated by output)
    output_folder = scenario_folder + OUTPUT_FOLDER_NAME + "/"
