...
from starling_sim.basemodel.output.kpis import MoveKPI, WaitKPI, SuccessKPI, DestinationReachedKPI, \
    GetVehicleKPI, StationOccupationKPI, StaffOperationKPI, LeaveSimulationKPI
...
class Output(OutputFactory):
    ...
    def setup_kpi_output(self):
        ...
        # stations kpi
        success_kpi = SuccessKPI(["nbSuccessGet", "nbFailedGet",
                                  "nbSuccessPut", "nbFailedPut"])
        wait_kpi = WaitKPI()
        ...
        self.kpi_outputs = [users_kpi_output, vehicles_kpi_output, stations_kpi_output, staff_kpi_output]
    ...
    def setup_geojson_output(self):
        ...
        information_factories = {"station": [stock_factory],
